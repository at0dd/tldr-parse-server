...
sudo curl https://github.com/at0dd/tldr-parse-server/blob/master/mongod.service > /lib/systemd/system/mongod.service
...
npm install
sudo curl https://github.com/at0dd/tldr-parse-server/blob/master/index.js > index.js
